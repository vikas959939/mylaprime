...
import logoImage from '../../../Images/delivery-image.jpg'
      ...
      <Link to="/dashboard">
        <div className="flex items-center space-x-4">
          <div className="logo-icon">
            {!isDark && !isSemiDark ? (
              //<img src="https://corp.lotuss.com.my/images/logo.png" width={150} style={{'backgroundColor':'#00BCB5'}} alt="" />
              <h4>Logo Here</h4>
            ) : (
              // <img src="https://corp.lotuss.com.my/images/logo.png" style={{'backgroundColor':'#00BCB5'}} alt="" />
              <h4>logo Here</h4>
            )}
          </div>
